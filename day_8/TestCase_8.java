...
public static void main(String[] args) throws IOException, InterruptedException, AWTException  {
		...
		FileInputStream fis = new FileInputStream("./src/test/resources/DDt/commondata1.properties");
		...
		//resume
		Thread.sleep(5000);
		p2.getResume("C:\\Users\\nithi\\Desktop\\New folder\\NithinkumarResume.pdf");
		p2.getSave();
